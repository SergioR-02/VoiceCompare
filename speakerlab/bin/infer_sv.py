...
Res2Net_3D_Speaker = {
    'obj': 'speakerlab.models.res2net.Res2Net.Res2Net',
    'args': {
        'feat_dim': 80,
        'embedding_size': 192,
    },
...
supports = {
    ...
    # Res2Net trained on 3dspeaker
    'iic/speech_res2net_sv_zh-cn_3dspeaker_16k': {
        'revision': 'v1.0.0', 
        'model': Res2Net_3D_Speaker,
        'model_pt': 'res2net_model.ckpt',
    },
...
def main():
    ...
    def load_wav(wav_file, obj_fs=16000):
        ...
        if fs != obj_fs:
            ...
            # Use functional.resample instead of sox_effects for Windows compatibility
